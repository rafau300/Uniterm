...
namespace Uniterm
{
    class DataBase
    {
        ...
        //public static string connectionString = "Data Source=KZI-VOSTRO2\\SQL Server Compact Edition;Initial Catalog=MyDatabase#2.sdf;Password=ovsyak; User Id=ovsyak";
        public static string connectionString = "Data Source=RAFAL-KOMPUTER;Initial Catalog=Uniterm;Integrated Security=True";
